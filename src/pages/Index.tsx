        ...
        <section className="mt-12 md:mt-16 mb-8 md:mb-12 border-y border-border/20 py-12">
          ...
          <div className="overflow-x-auto">
            <div className="flex items-center justify-center gap-12 md:gap-16 lg:gap-20 px-4 min-w-max mx-auto">
              <img src={logoVogue} alt="Vogue" className="h-12 md:h-14 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
              <img src={logoElle} alt="Elle" className="h-12 md:h-14 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
              <img src={logoGoop} alt="Goop" className="h-12 md:h-14 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
              <img src={logoWomensHealth} alt="Women's Health" className="h-12 md:h-14 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
              <img src={logoMindbodygreen} alt="Mindbodygreen" className="h-12 md:h-14 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
            </div>
          </div>
        </section>
