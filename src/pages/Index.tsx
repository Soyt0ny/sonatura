      ...
      <main className="container mx-auto px-4 pt-0 md:pt-8 pb-8 md:pb-12">
        ...
        <section className="mb-8 md:mb-12 border-y border-border/20 py-12">
          ...
          <div className="flex items-center justify-center gap-2 md:gap-12 lg:gap-16 px-2 md:px-4">
            <img src={logoVogue} alt="Vogue" className="w-16 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
            <img src={logoElle} alt="Elle" className="w-16 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
            <img src={logoGoop} alt="Goop" className="w-16 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
            <img src={logoWomensHealth} alt="Women's Health" className="w-16 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
          </div>
        </section>
