      ...
      <main className="container mx-auto px-4 pb-8 md:pb-12">
        ...
        <section className="mb-8 md:mb-12 border-y border-border/20 py-12">
          ...
          <div className="flex items-center justify-center gap-3 md:gap-12 lg:gap-16 px-2 md:px-4 overflow-x-auto">
            ...
            <img src={logoElle} alt="Elle" className="w-20 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
            <img src={logoGoop} alt="Goop" className="w-20 md:w-36 lg:w-44 flex-shrink-0 object-contain mix-blend-multiply dark:mix-blend-normal dark:invert transition-all duration-300" />
