...
const reviews = [{
  ...
  name: "Sofia V.",
  date: "hace 1 día",
  text: "No les miento, en 10 días ya se notaba el cambio. Mi cara estaba súper desinflada y el acné de la frente? Casi nada. He probado cremas de $80 que literally no hacían nada, pero esto es diferente porque trabajas desde adentro, no solo ponerte cosas encima. Total game changer para mi skin care routine ✨"
}, {
  id: 2,
  name: "Isabella M.",
  date: "hace 3 días",
