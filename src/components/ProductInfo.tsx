    ...
    <div className="w-full grid md:grid-cols-2 gap-8 md:gap-12">
      ...
      <div className="w-full md:max-w-2xl space-y-6">
        ...
        <div className="md:hidden space-y-4">
          ...
          <div>
            <h1 className="text-xl font-bold leading-tight">REALIFESTACIÓN LIBRO DIGITAL - último día 50% Off +4 regalos</h1>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-foreground mt-1">O solo $11.17/mes a 6 meses sin intereses                        </p>
          </div>
